...
6. Optional "Polish with LLM" sends the raw menu to an LLM provider of your choice (Anthropic, Google AI Studio, OpenAI, Kimi, DeepSeek, or Cerebras) using a key you paste locally, never stored server-side, and returns flavor text.
